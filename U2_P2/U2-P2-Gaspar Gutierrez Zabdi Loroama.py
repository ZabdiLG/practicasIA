...
#############################################################################
print(50 * '=')
print('Análisis de Supervivencia en el Titanic')
print(50 * '-')

X = df[["Pclass", "Parch"]].values
y = df["Survived"]

plt.scatter(X[y == 1, 0], X[y == 1, 1], color='r', marker='o', label='Sobrevivió')
plt.scatter(X[y == 0, 0], X[y == 0, 1], color='g', marker='x', label='No Sobrevivió')
plt.xlabel('Clase de Pasajero (Pclass)')
plt.ylabel('Número de Padres/Children (Parch)')
...
ada = AdalineGD(n_iter=5, eta=0.01)
ada.fit(X_std, y)

plot_decision_regions(X_std, y, classifier=ada)
plt.title('Análisis de Supervivencia en el Titanic')
plt.xlabel('Clase de Pasajero (Pclass)')
plt.ylabel('Parch')
plt.legend(loc='upper right', labels=['Sobrevivió', 'No Sobrevivió'])
